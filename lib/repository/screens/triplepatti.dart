...
import '../../bloc/triplepatti/triplepatti_bloc.dart';
import '../../bloc/triplepatti/triplepatti_event.dart';
import '../../bloc/triplepatti/triplepatti_state.dart';
import '../screens/walletscreen.dart';

class Triplepatti extends StatelessWidget {
  final String mid;
  final String cmid;
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (_) =>
      TriplepattiBloc()..add(LoadTriplepatti(mid: mid, cmid: cmid)),
      child: BlocBuilder<TriplepattiBloc, TriplepattiState>(
        builder: (context, state) {
          if (state is TriplepattiLoading) {
            return const Scaffold(
              body: Center(child: CircularProgressIndicator()),
            );
          } else if (state is TriplepattiLoaded) {
            return Scaffold(
                    ...
                    ElevatedButton(
                      onPressed: () {
                        if (digitController.text.isNotEmpty &&
                          ...
                          context.read<TriplepattiBloc>().add(AddBid(
          ...
          } else if (state is TriplepattiError) {
            return Scaffold(
